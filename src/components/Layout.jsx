    ...
    <>
      <div className="w-full h-auto text-center  2xl:px-32 sm:pt-20 2xl:pb-0 xl:px-20 xl:pb-0  lg:px-16  lg:pb-0 md:px-10 md:pb-0 sm:px-10 sm:pb-0 p-5">
        <div className="border-b-2 pb-20">
          ...
          <div className="h-auto grid grid-cols-2 md:grid md:grid-cols-4 gap-7 justify-center">
            {isLoading 
              ? [...new Array(4)].map((_) => (
      ...
      <div className="w-full h-auto text-center  2xl:px-32 sm:pt-20 2xl:pb-0 xl:px-20 xl:pb-0  lg:px-16  lg:pb-0 md:px-10 md:pb-0 sm:px-10 sm:pb-0 p-5">
        <h1 className="2xl:text-6xl sm:text-5xl text-4xl  font-bold text-center mb-20 uppercase">
          top selling
        </h1>
        <div className="h-auto grid w-full grid-cols-2 md:grid md:grid-cols-4  gap-10  ">
            {isLoading 
              ? [...new Array(4)].map((_) => (
                  <div className="grid grid-cols-4 mb-2">
                    <div
