...
function ColorBox() {
  ...
  return (
    <>
      <div
        onClick={() => setColorUp(!ColorUp)}
        className="w-full h-auto  bg-white relative z-[20] top-[340px] "
      >
        <div className="w-full h-auto border-b-2 ">
          ...
          <div className="absolute z-[10] top-6 cursor-pointer  right-10 text-2xl">
            <ion-icon
              name={
                ColorUp ? "chevron-down-outline" : "chevron-forward-outline"
              }
            ></ion-icon>
          </div>
        </div>
        <div
          className={`w-full h-auto absolute z-1 duration-500 bg-white  ${ColorUp ? "top-[62px]" : "top-[-350px]"}`}
        >
