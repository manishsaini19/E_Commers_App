    ...
    <>
      <div className="w-full h-auto">
        ...
        <div className=" flex gap-7 justify-between ">
          {HAPPYCARD.map((item) => (
            <div className="w-[400px] h-[240px]  py-8 px-4 border-2 rounded-3xl hover:bg-gray-100 cursor-pointer" key={item.title}>
              <div className="flex  gap-2 items-center mb-3 text-yellow-500">
               ...
               <h1 className="flex items-center mb-2">{item.name}
